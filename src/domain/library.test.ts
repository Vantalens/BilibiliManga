...
const items = [
  { id: "1", title: "星海", groups: ["追更"], tags: ["科幻"], rating: 5, unreadChapters: 2 },
  { id: "2", title: "夜行", groups: ["完结"], tags: ["悬疑"], rating: 4, unreadChapters: 0 },
  { id: "3", title: "星城", groups: ["追更"], tags: ["日常"], rating: 3, unreadChapters: 1 }
];
